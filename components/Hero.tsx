      ...
      <div className="sub-container">
        <div className={styles.hero__inner}>
          ...
          <p className={styles.hero__description}>
            Web development Вы работаете над чем-то великим?Я с удовольствием
            помогу вам в этом! Напишите мне письмо и мы начнем проект прямо
            сейчас! Связаться с разработчиком Светлана Котлукова
          </p>
          <Link
            to="contact"
            spy={true}
